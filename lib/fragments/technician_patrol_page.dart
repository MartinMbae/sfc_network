...
class TechnicianPatrolPage extends StatefulWidget {
  @override
  _TechnicianPatrolPageState createState() => _TechnicianPatrolPageState();
}

class _TechnicianPatrolPageState extends State<TechnicianPatrolPage> {

  String condition = "all";
  Future<String> fetchEngineerPatrols() async {

    SessionManager prefs = SessionManager();
    String techId =await prefs.getId();

    var url = "${BASE_URL}index.php/v1/api/patrollinguser/$techId/$condition";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("My previous Patrols"),
      ),
