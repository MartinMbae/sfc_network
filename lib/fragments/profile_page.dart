...
class MapScreenState extends State<ProfilePage>
  ...
  Widget build(BuildContext context) {
    ...
    nameTextController.text = "${widget.loggedInUser.firstName} ${widget.loggedInUser.lastName}";
    emailController.text = "${widget.loggedInUser.email}";
    phoneController.text = "${widget.loggedInUser.phone}";
